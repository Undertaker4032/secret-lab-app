<script lang="ts">
  import type { Documentation } from '$lib/utils/documentation';

  export let document: Documentation;
  ...
  <div class="flex items-start justify-between">
    ...
    <div class="flex-1 min-w-0">
      <div class="flex items-center gap-3 mb-2">
        ...
        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-900/30 text-red-300 border border-red-700 whitespace-nowrap flex-shrink-0">
          {document.required_clearance_name}
        </span>
      </div>
